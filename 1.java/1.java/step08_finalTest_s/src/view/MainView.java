...
public class MainView {
	...
	public static void main(String[] args) {
		...
		BoardController.insertBoard("photo", new PhotoBoard(20, "Java", "이나영", "안녕", "2016-10-20", "a.gif"));//글번호 없는 게시물등록
		
		System.out.println();
		System.out.println("-----이미 존재하는 게시물 등록 하려는 경우 test----- ");
		BoardController.insertBoard("photo", new PhotoBoard(10, "Java", "이나영", "안녕", "2016-10-20", "a.gif"));//글번호 이미 있는 게시물등록
